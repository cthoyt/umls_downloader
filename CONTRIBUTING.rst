...
----------------------------------
1. Check that you have the latest version of :code:`umls_downloader`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/umls_downloader/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/umls_downloader
...
If you spend a while working on your changes, further commits may be made to the main :code:`umls_downloader`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/umls_downloader
